...
# --- Data loading (same as Google version) ---
def load_data():
    documents = []
    try:
...
async def on_chat_start():
    ...
    await cl.Message(content="Hello! I'm your company assistant (powered by OpenAI). Ask me anything about our services, expertise, or company!").send()
